...
import { TOOL_NAMES as DYNAMIC_TOOL_NAMES, DYNAMIC_LOADING_TOOLS } from './dynamic-loading';
import { TOOL_NAMES as EXTRACTION_TOOL_NAMES, DYNAMIC_EXTRACTION_TOOLS } from './dynamic-extraction';
import { TOOL_NAMES as OPTIMIZATION_TOOL_NAMES, DYNAMIC_OPTIMIZATION_TOOLS } from './dynamic-optimization';
...
export const TOOL_NAMES = {
  BROWSER: {
    ...
    POST_MESSAGE: 'chrome_post_message',
  },
  DYNAMIC: {
    LOADING: DYNAMIC_TOOL_NAMES.DYNAMIC_LOADING,
    EXTRACTION: EXTRACTION_TOOL_NAMES.DYNAMIC_EXTRACTION,
    OPTIMIZATION: OPTIMIZATION_TOOL_NAMES.DYNAMIC_OPTIMIZATION,
  },
};

export const TOOL_SCHEMAS = [
  ...DYNAMIC_LOADING_TOOLS,
  ...DYNAMIC_EXTRACTION_TOOLS,
  ...DYNAMIC_OPTIMIZATION_TOOLS,
  {
    type: NativeMessageType.CALL_TOOL,
    payload: {
      toolName: TOOL_NAMES.BROWSER.GET_WINDOWS_AND_TABS,
      toolDescription: 'Get all currently open browser windows and tabs',
      toolInputSchema: {
        type: 'object',
        properties: {},
        required: []
  ...
  },
  {
    ...
    payload: {
      ...
      toolDescription: 'Navigate to a URL or refresh the current tab',
      toolInputSchema: {
        type: 'object',
        properties: {
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        viewportWidth: { type: 'number', description: 'Viewport width in pixels (default: 1280)' },
        viewportHeight: { type: 'number', description: 'Viewport height in pixels (default: 720)' },
        refresh: {
          type: 'boolean',
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        url: {
          type: 'string',
          description: 'If a URL is specified, inject the script into the webpage corresponding to the URL.',
        },
        type: {
          type: 'string',
        ...
        allFrames: {
          type: 'boolean',
          description: 'Inject into all frames of the page',
        },
      },
      required: ['jsScript'],
    },
  },
  {
    ...
    description: 'Send a command to an injected script',
    inputSchema: {
      type: 'object',
      properties: {
        tabId: {
          type: 'number',
          description: 'ID of the tab where the script was injected',
        },
        eventName: {
          type: 'string',
        ...
        payload: {
          type: 'string',
          description: 'Command payload as JSON string',
        },
      },
      required: ['eventName'],
    },
